...
'https://ssl-jadabackend.azurewebsites.net/');
(function() {
    'use strict';
...
(function() {
    ...
    function appRun($rootScope, $state, $stateParams, $window, $templateCache, Colors, $localStorage , $location) {
        ...
        $rootScope.$on('$locationChangeStart', function (event, next, current) {
            ...
            if (restrictedPage &&  !$rootScope.$storage.userId) {
    ...
    function routesConfig($stateProvider, $locationProvider, $urlRouterProvider, helper){
        ...
        $stateProvider
          ...
          .state('app.p9', {
              url: '/p9',
              title: 'p9',
              templateUrl: helper.basepath('p9.html'),
              resolve: helper.resolveFor('filestyle')
          })
          .state('app.leave-application', {
              url: '/leave-application',
              title: 'leave application',
              templateUrl: helper.basepath('leave-application.html'),
              resolve: helper.resolveFor('filestyle')
          })    
          .state('app.leave-application-list', {
              url: '/leave-application-list',
              title: 'leave application-list',
              templateUrl: helper.basepath('leave-application-list.html'),
              resolve: helper.resolveFor('datatables')
          })                  
          .state('app.plans', {
              url: '/plans',
